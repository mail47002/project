                                        ...
                                        <div class="bs-stepper-header px-0" role="tablist">
                                            ...
                                            <div class="step" data-target="#personal-info" role="tab" id="personal-info-trigger">
                                                <button type="button" class="step-trigger">
                                                    ...
                                                    <span class="bs-stepper-label">
                                                        <span class="bs-stepper-title">Bin Location</span>
                                                    </span>
                                                </button>
                                            </div>
                                        </div>
                                        <div class="bs-stepper-content px-0 mt-1">
                                            <div 
                                                ...
                                                <div class="content-header mb-2">
                                                    <h2 class="fw-bolder mb-75">Locations Details</h2>
                                                </div>
                                                <form class="form form-vertical" @submit.prevent="createLocation" method="post">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-1">
                                            ...
                                            <div id="personal-info" class="content" role="tabpanel" aria-labelledby="personal-info-trigger">
                                              <form class="form form-vertical" @submit.prevent="createLocation" method="post">
                                                    <div role="tabpanel" class="tab-pane" id="address" aria-labelledby="home-tab" aria-expanded="true">
                                                        <div class="card">
                                                            <div class="content-header mb-2">
                                                                <h2 class="fw-bolder mb-75"> Location</h2>
                                                            </div>
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-md-6">
...
export default {
    ...
    methods: {
        createLocation() {
            ...
            this.form.post("/admin/location/store");
        },
